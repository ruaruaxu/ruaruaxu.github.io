...
I develop methods to **evaluate, interpret, and improve large language models and geospatial foundation models**, with a focus on **reliability, fairness, and alignment** with human and societal needs. I apply these methods to spatial and environmental domains, including **environmental hazards, urban systems, and public health**. Broadly, my work sits at the intersection of *AI for Science, Trustworthy AI, and AI for Social Good*, with the goal of building AI systems that advance scientific understanding, support decision-making under uncertainty, and inform more equitable environmental planning and public-sector applications.
